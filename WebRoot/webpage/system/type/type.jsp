...
<t:formvalid formid="formobj" layout="div" dialog="true" action="systemController.do?saveType">
    ...
    <fieldset class="step">
        ...
        <div class="form">
            ...
            <input name="typename" class="inputxt" value="${type.typename }" datatype="s1-25">
            <span class="Validform_checktip">类型范围在1~25位字符</span>
        </div>
        <div class="form">
            ...
            <span class="Validform_checktip">类型编码在1~25位字符</span>
        </div>
    </fieldset>
</t:formvalid>
</body>
