...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="tMcWorkOrderController.do?doAdd" tiptype="1" >
...
>    
				...
				<tr>
					...
					<td class="value">
					     	 <input id="ownHouse" name="ownHouse" type="text" style="width: 150px" class="inputxt" >
							<span class="Validform_checktip"></span>
