...
<html>
		...
		<tr>
			...
			<div style="width: auto;height: 200px;">
				...
				<t:tabs id="tt" iframe="false" tabPosition="top" fit="false">
				 <t:tab href="tMcCustomResourceController.do?tMcCustomResourceProblemList&id=${tMcCustomResourcePage.id}" icon="icon-search" title="问题记录" id="tMcCustomResourceProblem"></t:tab>
				</t:tabs>
			</div>
			</t:formvalid>
			<!-- 添加 附表明细 模版 -->
 ...
 <script src = "webpage/com/jeecg/mcredit.resource/tMcCustomResource.js"></script>	
