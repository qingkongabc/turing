...
<div align="center" class="container loginBg">
    ...
    <div class="login">
    	<ul class="titleName">
        	<li class="english">TURING|BPMN</li>
    ...
    <div class="copyright ">
    	<span>&copy; TURING 版权所有 <span class="tip"><a href="#" title=TURING 演示系统>jeecg</a> (推荐使用IE8+,谷歌浏览器) 技术支持：:<a href="#" title=TURING 演示系统>jeecg</a></span></span>
    </div>       
</div>
</form>
