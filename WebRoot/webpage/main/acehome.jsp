...
<body class="gray-bg" style="background-color: aliceblue">
    <div class="row  border-bottom white-bg dashboard-header" style="height: 99%">
    	<div style="font-size: larger;margin-top: 20%" align="center"><img src="webpage/main/main.png" style="width: 100%"/></div>
    </div>
